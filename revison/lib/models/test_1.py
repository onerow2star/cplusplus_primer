...
class PoseHighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.part_refine_layer = conv_bn_relu(2, 2, kernel_size=1,
                                              stride=1, padding=0, has_bn=True, has_relu=True)
        self.se_layer = SELayer(channel = 2, reduction=1)
    ...
    def forward(self, x):
        ...
        # se
        kk10_res = self.se_layer(kk10_res)
        ...
        # se
        kk11_res = self.se_layer(kk11_res)
        ...
        # se
        kk12_res = self.se_layer(kk12_res)
        ...
        # se
        kk13_res = self.se_layer(kk13_res)
        ...
        # se
        kk14_res = self.se_layer(kk14_res)
        ...
        # se
        kk15_res = self.se_layer(kk15_res)
